...
export function DateBar() {
  ...
  return (
    <div className="relative py-8 bg-black/40 backdrop-blur-md overflow-hidden">
      {/* Decorative lines */}
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-2xl mx-auto relative group">
          {/* Outer glow */}
          <div className="absolute -inset-1 bg-gradient-to-r from-white/5 via-white/10 to-white/5 rounded-2xl blur-lg opacity-50 group-hover:opacity-100 transition duration-1000"></div>
          ...
          <div className="relative flex items-center justify-center gap-6 bg-white/5 border border-white/10 backdrop-blur-md py-4 px-8 rounded-2xl shadow-2xl">
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col items-start">
                <span className="text-[10px] font-black uppercase tracking-[0.2em] text-white/40 mb-0.5">Aktualna Data</span>
